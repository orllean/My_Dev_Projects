...
if t:
    if n1 == n2 == n3:
        print(
            f'MACHINE: Humano! com as retas {n1, n2, n3} você FORMA UM TRIÂNGULO EQUILATERO.')
    elif (n1 == n2) or (n2 == n3) or (n1 == n3):
        print(
            f'MACHINE: Humano! com as retas {n1, n2, n3} você FORMA UM TRIÂNGULO ISÓSCELES.')
    else:
        print(
            f'MACHINE: Humano! com as retas {n1, n2, n3} você FORMA UM TRIÂNGULO ESCALENO.')
else:
